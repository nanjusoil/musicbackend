        ...
        if (raw) {
          ...
          let playlists = json.list.map(item => {
            ...
            return {
              ...
              coverSmall:
                originCover.substr(0, originCover.length - 4) + '/150',
...
const getLyrics = key => {
  let url = `http://c.y.qq.com/lyric/fcgi-bin/fcg_query_lyric.fcg?nobase64=1&musicid=${key}&callback=jsonp1&g_tk=5381&loginUin=0&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0`;
  return new Promise((resolve, reject) => {
    fetch(url, {headers: {
